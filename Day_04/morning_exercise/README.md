...
| git | log| --graph |  Shows an ASCII graph representing the branch structure of the commit history_`q` to exit_|
...
It will be a new message along the top of github OR from clicking the `Branch: master` button <details><summary> Screenshot </summary> 
